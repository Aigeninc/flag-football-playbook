...
const PLAYS = [
  // ── 1. MESH ────────────────────────────────────────────────────────────
  {
    ...
    players: {
      ...
      Lenox:    { pos: [17.5, 0.5],  route: [[22, 3], [27, 5]], label: 'CHECK', read: 4, dashed: true },
      Greyson:  { pos: [4, 0.5],     route: [[4, 5], [32, 5]], label: 'MESH', read: 1, dashed: false },
      Cooper:   { pos: [24, 0.5],    route: [[24, 6], [3, 6]], label: 'MESH', read: 2, dashed: false,
                  motion: { from: [31, 0.5], to: [24, 0.5] } },
  ...
  // ── 2. QUICK OUT ───────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[22, 3], [28, 5]], label: 'CHECK', read: 4, dashed: true },
      Marshall: { pos: [4, 0.5],     route: [[4, 5], [0.5, 5]], label: 'OUT', read: 1, dashed: false },
      Cooper:   { pos: [31, 0.5],    route: [[31, 2], [23, 7]], label: 'SLANT', read: 2, dashed: false },
  ...
  // ── 3. FLOOD RIGHT ─────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 4, dashed: true },
      Greyson:  { pos: [27, 0.5],    route: [[27, 6], [33, 16]], label: 'CORNER', read: 1, dashed: false },
      Marshall: { pos: [32, 0.5],    route: [[32, 8], [34, 8]], label: 'OUT', read: 2, dashed: false },
  ...
  // ── 4. REVERSE ─────────────────────────────────────────────────────────
  {
    ...
    players: {
      ...
      Lenox:    { pos: [17.5, 0.5],  route: [[23, 3], [28, 5]], label: 'CHECK', read: 0, dashed: true },
      Greyson:  { pos: [31, 0.5],    route: [[31, 18]], label: 'GO (decoy)', read: 0, dashed: false },
  ...
  // ── 5. RPO SLANT ───────────────────────────────────────────────────────
  {
    ...
    players: {
      ...
      Lenox:    { pos: [17.5, 0.5],  route: [[23, 3], [28, 5]], label: 'CHECK', read: 2, dashed: true },
      Cooper:   { pos: [4, 0.5],     route: [[4, 2], [14, 7]], label: 'SLANT', read: 1, dashed: false },
      Greyson:  { pos: [31, 0.5],    route: [[31, 14]], label: 'GO (clear)', read: 0, dashed: false },
  ...
  // ── 6. QUICK SLANTS NRZ ────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 4, dashed: true },
      Greyson:  { pos: [4, 0.5],     route: [[4, 2], [12, 5]], label: 'SLANT', read: 1, dashed: false },
      Marshall: { pos: [31, 0.5],    route: [[31, 2], [23, 5]], label: 'SLANT', read: 2, dashed: false },
  ...
  // ── 7. FLAT-WHEEL ──────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 4, dashed: true },
      Cooper:   { pos: [4, 0.5],     route: [[4, 2], [12, 6]], label: 'SLANT', read: 2, dashed: false },
      Marshall: { pos: [31, 0.5],    route: [[33, 2], [33, 20]], label: 'WHEEL!', read: 1, dashed: false,
  ...
  // ── 8. BRAELYN LATERAL ─────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [[17.5, -1], [25, 4]], label: 'FLAT', read: 1, dashed: false,
                  lateralTo: [22, -5] },
      Lenox:    { pos: [17.5, 0.5],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 4, dashed: true },
      Greyson:  { pos: [4, 0.5],     route: [[4, 3], [14, 8]], label: 'SLANT', read: 2, dashed: false },
      Cooper:   { pos: [31, 0.5],    route: [[31, 18]], label: 'GO (clear)', read: 3, dashed: false },
  ...
  // ── 9. FLOOD LEFT ──────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[23, 3], [28, 5]], label: 'CHECK', read: 4, dashed: true },
      Cooper:   { pos: [8, 0.5],     route: [[8, 6], [2, 16]], label: 'CORNER', read: 1, dashed: false },
      Marshall: { pos: [3, 0.5],     route: [[3, 8], [1, 8]], label: 'OUT', read: 2, dashed: false },
  ...
  // ── 10. HITCH & GO ─────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[22, 3], [28, 5]], label: 'CHECK', read: 4, dashed: true },
      Greyson:  { pos: [4, 0.5],     route: [[4, 5], [4, 20]], label: 'GO!', read: 1, dashed: false,
                  fakeSegment: [[4, 0.5], [4, 5]], fakeLabel: 'FAKE HITCH' },
      Cooper:   { pos: [11, 0.5],    route: [[11, 5]], label: 'HITCH', read: 2, dashed: false,
                  motion: { from: [31, 0.5], to: [11, 0.5] } },
      Marshall: { pos: [17.5, -5.5], route: [[17.5, -3.5], [6, 1]], label: 'FLAT', read: 3, dashed: false },
    },
  ...
  // ── 11. SCREEN ─────────────────────────────────────────────────────────
  {
    ...
    players: {
      ...
      Lenox:    { pos: [17.5, 0.5],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 2, dashed: true },
      Greyson:  { pos: [4, 0.5],     route: [[4, 18]], label: 'GO (sell deep)', read: 0, dashed: true },
      Marshall: { pos: [31, 0.5],    route: [[31, 18]], label: 'GO (sell deep)', read: 0, dashed: true },
  ...
  // ── 12. DRAG CROSS ─────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 4, dashed: true },
      Greyson:  { pos: [24, 0.5],    route: [[28, 2], [24, 4], [3, 4]], label: 'DRAG', read: 1, dashed: false,
                  fakeSegment: [[24, 0.5], [28, 2]], fakeLabel: 'FAKE OUT',
                  motion: { from: [4, 0.5], to: [24, 0.5] } },
      Cooper:   { pos: [31, 0.5],    route: [[33, 2], [31, 6], [3, 6]], label: 'DRAG', read: 2, dashed: false,
  ...
  // ── 13. FADE ───────────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0.5],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 4, dashed: true },
      Marshall: { pos: [31, 0.5],    route: [[33, 5], [34, 14]], label: 'FADE!', read: 1, dashed: false },
      Cooper:   { pos: [4, 0.5],     route: [[4, 2], [12, 6]], label: 'SLANT', read: 2, dashed: false },
