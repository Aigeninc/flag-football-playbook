...
const PLAYS = [
  // ── 1. MESH ────────────────────────────────────────────────────────────
  {
    ...
    players: {
      ...
      Cooper:   { pos: [24, 0],    route: [[24, 6], [3, 6]], label: 'MESH', read: 2, dashed: false,
  ...
  // ── 10. HITCH & GO ─────────────────────────────────────────────────────
  {
    ...
    players: {
      ...
      Cooper:   { pos: [11, 0],    route: [[11, 5]], label: 'HITCH', read: 2, dashed: false,
  ...
  // ── 12. DRAG CROSS ─────────────────────────────────────────────────────
  {
    ...
    players: {
      Braelyn:  { pos: [17.5, -3],   route: [], label: '', read: 0, dashed: false },
      Lenox:    { pos: [17.5, 0],  route: [[12, 3], [7, 5]], label: 'CHECK', read: 4, dashed: true },
      Greyson:  { pos: [24, 0],    route: [[28, 2], [24, 4], [3, 4]], label: 'DRAG', read: 1, dashed: false,
